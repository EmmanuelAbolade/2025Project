        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <p className="mb-4">
                We make life easy for guests and staff of hotels to make
                communication seemingly effortless and get things done much
                quickly while guests have the best experience staying at the
                hotel.
              </p>
